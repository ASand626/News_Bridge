...
import { GLOSSARY_SYSTEM_PROMPT, ENGLISH_GLOSSARY_SYSTEM_PROMPT } from "@/lib/claude/prompts";
...
export async function GET(
  ...
  const systemPrompt = lang === "en" ? ENGLISH_GLOSSARY_SYSTEM_PROMPT : GLOSSARY_SYSTEM_PROMPT;
  const userMessage = `用語「${decoded}」を説明してください。`;
